...
| 스킬 | 설명 | 출시 |
|---|---|---|
| [weekly-report](./skills/weekly-report/SKILL.md) | 한국 WBR 6섹션 주간보고 + 임원 1pager | ✅ v1.6.0 |
| standup-summarizer | 일일 스탠드업 노트 → 5줄 요약 | ⏸️ v1.9+ |
| task-decomposer | Goal → Epic → Story → Task 4단 분해 | ⏸️ v1.9+ |
| okr-tracker | OKR 진행률 + 분기 회고 자료 | ⏸️ v1.9+ |
| retro-facilitator | KPT/4Ls 회고 자동화 | ⏸️ v1.9+ |
