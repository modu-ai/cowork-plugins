...
한국 실무 플러그인 패밀리(18종) + 4트랙 한국어 문서 사이트를 한 곳에. Claude Code / Claude Desktop에서 한 번의 등록으로 전 플러그인을 모두 만나고, 비개발자부터 개발자까지 4가지 Claude 제품(Chat · Cowork · Design · Code) 활용 가이드를 제공합니다.
...
```
modu-ai/moai-cowork/
├── .claude-plugin/marketplace.json   # 마켓 매니페스트 (18 plugins, name: moai-cowork)
