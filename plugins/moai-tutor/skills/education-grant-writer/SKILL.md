...
- 연구팀 구성 및 참여 기관
- 연구 기간 및 예산 규모
- 선행연구 현황 (선행연구 조사 필요시 moai-tutor:education-paper-search 연계)
...
`education-grant-writer → moai-coworker:general-ai-slop-reviewer → moai-writer:general-humanize-korean`
