...
| media-codex-image | after | 생성된 프롬프트로 codex CLI(gpt-image-2, OAuth·API 키 불필요) 이미지 생성 |
| media-higgsfield-image | after | 생성된 프롬프트로 Higgsfield MCP 직접 이미지 생성 (GPT Image 2·Nano Banana Pro 포함) |
