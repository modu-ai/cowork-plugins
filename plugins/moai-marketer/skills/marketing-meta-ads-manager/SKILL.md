...
|---|---|---|---|
| **marketing-meta-ads-manager** (본 스킬) | Meta 광고 **라이브 운영** (공식 MCP) | 생성·수정·예산·온오프 | 운영 동사만 |
| marketing-meta-ads-analyzer | Meta 광고 보고서 **분석·진단** (read/report) | 분석·해석·리포트 | "분석/진단/리포트" 요청은 analyzer로 |
| marketing-pixel-audit | 픽셀·CAPI **설치 검증** | 점검·검증 | "픽셀 설치 확인"은 marketing-pixel-audit로 |
| marketing-campaign-planner | 캠페인 **기획**(인지편향) | 기획·설계 | "캠페인 기획/전략"은 planner로 |
