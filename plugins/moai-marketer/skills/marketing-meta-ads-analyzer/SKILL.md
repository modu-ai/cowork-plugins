...
| 페어 스킬 | 책임 | 본 스킬과의 경계 |
|----------|------|-----------------|
| `moai-marketer:marketing-pixel-audit` | 메타 픽셀·인프라 진단 | 픽셀 설치·CAPI·Lookalike 씨앗 → moai-marketer:marketing-pixel-audit, 보고서 결과 분석 → 본 스킬 |
| `moai-marketer:marketing-landing-page-conversion-audit` | 랜딩 6섹션 전환율 진단 | 광고 클릭 후 랜딩 UX → 페어, 광고 시스템 KPI(노출/클릭/구매/매출/ROAS) → 본 스킬 |
| `moai-marketer:marketing-campaign-planner` | 캠페인 사전 기획 | 사전 기획(목표·타겟·소재 컨셉) → moai-marketer:marketing-campaign-planner, 집행 후 사후 진단·액션 → 본 스킬 |
