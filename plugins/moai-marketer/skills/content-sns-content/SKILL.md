...
description: |
  인스타·네이버 블로그·카카오부터 스레드·X·링크드인·페이스북·유튜브 쇼츠까지, 채널에 맞춘 SNS 게시글과 캡션·해시태그·스크립트를 써 드립니다.
  다음과 같은 요청 시 사용하세요:
  - "인스타 피드 글 5개 써줘"
  - "네이버 블로그 포스팅 해줘"
  - "링크드인 포스팅 만들어줘"
...
인스타그램·네이버 블로그·카카오 채널(한국 3채널) + 스레드·X·링크드인·페이스북·유튜브 쇼츠(글로벌 5채널) SNS 최적화 콘텐츠를 제작합니다.

브랜드 아이덴티티, 브랜드 보이스 가이드, 콘텐츠 재활용(리퍼포징), 퍼스널 브랜딩 전략을 포함한 종합 SNS 콘텐츠 서비스를 제공합니다. 한국 3채널과 글로벌 5채널, 채널별 심리 상태 매트릭스, 메타 광고 학습 기간 가이드를 함께 다룹니다.

## 트리거 키워드

SNS, 인스타그램, 인스타 릴스, 네이버 블로그, 카카오 채널, 스레드, Threads, X, 트위터, 링크드인, LinkedIn, 페이스북, Facebook, 페이스북 릴스, 페이스북 그룹, 유튜브 쇼츠, YouTube Shorts, 콘텐츠, 브랜딩, 퍼스널 브랜딩, 브랜드 보이스, 글로벌 SNS, 한국 SNS, 콘텐츠 달력, 리퍼포징, 해시태그 전략, 숏폼
...
### 모드 2: 글로벌 5채널 (B2B·SaaS·해외 마케터용)

- 스레드 (Threads)
- X (구 Twitter)
- 링크드인 (LinkedIn)
- 페이스북 (Facebook — 페이지·릴스·그룹)
- 유튜브 쇼츠 (YouTube Shorts)

### 모드 3: 통합 (한·글로벌 8채널 동시)

## 워크플로우

### 1단계: 모드·채널·콘텐츠 유형 확인

대상 모드 선택(한국/글로벌/통합) → 채널 선택(인스타·블로그·카톡·스레드·X·링크드인·페이스북·쇼츠) → 콘텐츠 유형(피드/릴스/스토리/블로그/포스트/숏폼) → 브랜드 톤·타겟 오디언스 확인.
...
**[글로벌] 페이스북 (Facebook)**
- 릴스 우선: 영상은 릴스로 업로드 (일반 게시물 대비 5-10배 도달)
- 캡션 첫 125자 안에 핵심 (더 보기 전), 외부 링크는 첫 댓글에
- 게시 후 30-60분 내 댓글 velocity 확보 (30분 내 댓글 10개 → 도달 3-5배)
- 3표면 전략: 릴스(발견) → 페이지 피드(연결) → 그룹(커뮤니티, 도달 40-50%)
- 페이지 오가닉 도달 ~1.65% — 릴스·그룹으로 우회, 광고는 CAPI 전환 추적
...
- 페이스북: 릴스 스크립트/피드 캡션, 첫 댓글 링크, 그룹 프롬프트, CTA
- 유튜브 쇼츠: Hook, 자막, 스크립트
...
| 스킬 | 사용 시점 |
|------|----------|
| `moai-marketer:marketing-campaign-planner` | 마케팅 캠페인 전체 기획·광고 집행 전략 |
...
| **페이스북 (Facebook)** | 발견 + 커뮤니티 소속 | 심리적·정체성·관계 | 릴스로 발견(0-3초 후크) → 그룹으로 커뮤니티 결속. 페이지 브로드캐스트 ❌ 릴스·그룹 ✅ |
| **쿠팡** (참고) | 즉시 구매 의도 | 기능적 | `moai-seller:commerce-marketplace-coupang-ads`로 연계 |
...
| references/facebook.md | 페이스북 콘텐츠 — 규격·릴스 우선 알고리즘·도달 메커니즘·그룹·CTA·광고 vs 오가닉·체크리스트 (2026) |
