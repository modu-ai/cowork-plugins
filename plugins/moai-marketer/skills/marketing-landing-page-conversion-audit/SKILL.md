...
```json
{
  ...
  "next_actions": [
    ...
    "Phase 3 (1개월): 6섹션 전면 리뉴얼 (moai-marketer:marketing-landing-page 호출)"
  ]
}
```
...
marketing-landing-page-conversion-audit (진단)
       ↓ Phase 1·2 빠른 처방
moai-marketer:content-copywriting (헤드라인·CTA 카피)
       ↓ Phase 3 전면 리뉴얼 필요 시
...
| 페어 스킬 | 차이 |
|----------|------|
| `moai-marketer:marketing-landing-page` | 신규 랜딩 코드 생성 (shadcn/ui) — 본 스킬은 기존 랜딩 진단·개선 |
| `moai-marketer:marketing-campaign-planner` | 캠페인 전체 기획 (본 스킬은 랜딩 단일 진단) |
| `moai-seller:commerce-detail-page-copy` | 이커머스 13섹션 상세페이지 (본 스킬은 캠페인 랜딩) |
