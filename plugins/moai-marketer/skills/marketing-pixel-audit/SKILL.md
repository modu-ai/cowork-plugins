...
marketing-pixel-audit (본 스킬, 픽셀·1st Party 인프라 진단)
       ↓ Phase 1 즉시 수정 후
moai-marketer:marketing-campaign-planner (인프라 기반 캠페인 기획 + 9 인지 편향 적용)
       ↓ 메타·구글 광고 운영 시
moai-marketer:content-sns-content (채널별 심리 상태 매트릭스 + CAPI 검증)
       ↓ 쿠팡 광고는 별도로
...
| 페어 스킬 | 차이 |
|----------|------|
| `moai-marketer:marketing-performance-report` | GA4·메타·네이버 ROAS 종합 분석 (본 스킬은 픽셀·데이터 인프라 검증) |
| `moai-marketer:marketing-campaign-planner` | 캠페인 기획·운영 (본 스킬은 데이터 인프라 진단) |
| `moai-seller:commerce-marketplace-coupang-ads` | 쿠팡 광고 (본 스킬은 메타·구글 픽셀) |
