...
description: |
  ...
  **프로젝트 전용 커스텀 에이전트와 스킬 체인**을 설계해 `AGENTS.md`(폴더 지침 정본, ≤200라인)와 이를 `@AGENTS.md`로 불러오는 `CLAUDE.md`·`.claude/agents/`·`.moai/` 스캐폴드를 생성한다.
