---
name: business-people-operations
description: >
...
```
business-people-operations → moai-coworker:general-ai-slop-reviewer → moai-writer:general-humanize-korean
```
...
> 협업 도구 비교표·생산성 지표 표 같은 **표 산출물**은 위 텍스트 체인 대상이 아닙니다. 표가 필요하면 `moai-officer:office-xlsx-creator`로 라우팅하세요.
