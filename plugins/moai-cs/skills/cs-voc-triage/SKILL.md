...
description: |
  ...
  [책임 경계] 응답 메시지 카피 작성은 moai-cs:cs-channel-message, 분석 결과 PPT는 moai-officer:office-pptx-designer로 위임.
version: "1.0.0"
---
...
→ 두 채널 리뷰 1,000+ 통합 → 4단 분석 → (선택) office-pptx-designer PPT 자동화
```
...
```text
리뷰 집계 모드 → moai-coworker:general-ai-slop-reviewer → (선택) moai-officer:office-pptx-designer
...
- `moai-officer:office-pptx-designer` — 리뷰 분석 결과 PPT 자동화
