...
1. **긴급도 재판정**: business-ticket-triage 결과 확인 또는 직접 입력 내용 분석
...
```
business-escalation-manager → moai-coworker:general-ai-slop-reviewer → moai-writer:general-humanize-korean
```
...
- **초기 티켓 분류 및 긴급도 판단** → moai-cs:business-ticket-triage 스킬이 더 적합합니다
- **일반 고객 응답 초안 작성** → moai-cs:business-draft-response 스킬을 사용하세요
