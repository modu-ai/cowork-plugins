...
1. **스타일이 입혀진 HTML 리포트** (예: `moai-officer:doc-html-report`·`moai-officer:doc-html-slide` 산출물,
...
그대로 렌더합니다. `moai-officer:doc-html-report`·`moai-officer:doc-html-slide` 산출물을 그대로 넘기면
