...
"moai-imweb": {
  "command": "uv",
  "args": ["run", "--directory", "${CLAUDE_PLUGIN_ROOT}/mcp-servers/moai-mcp-imweb", "moai-mcp-imweb"],
  "env": {
