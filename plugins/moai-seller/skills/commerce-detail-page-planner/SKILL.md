...
| 단계 | 스킬 | 산출물 |
|------|------|--------|
| 1. 기획·전략 (★ **본 스킬**) | `moai-seller:commerce-detail-page-planner` | **Brief** (원 메시지·오프닝·본문 뼈대·채널·이미지 체크리스트) |
| 2. 카피 | `moai-seller:commerce-detail-page-copy` | 13섹션 감정여정 JSON |
| 3. 코드 | `moai-seller:commerce-product-detail` | shadcn/ui React 또는 HTML |
| 4. 이미지 | `moai-seller:commerce-detail-page-image` | 1080×12720 합성 PNG |
...
후속 스킬 호출:
```
1. brief 산출 후 → moai-seller:commerce-detail-page-copy "Brief: <yaml>"
2. 카피 JSON 산출 후 → moai-seller:commerce-product-detail "Brief + Copy"
3. 코드 산출 후 → moai-seller:commerce-detail-page-image "Brief + Copy + Code"
```
...
→ Brief 완성 후: moai-seller:commerce-detail-page-copy → commerce-product-detail → moai-seller:commerce-detail-page-image 순차 위임

## 페어 스킬과의 관계

### 본 스킬을 사용하지 않는 경우 (페어 위임)

- "상세페이지 카피 만들어줘" → `moai-seller:commerce-detail-page-copy` (13섹션 JSON)
- "상세페이지 코드 만들어줘" → `moai-seller:commerce-product-detail` (shadcn/ui 컴포넌트)
- "상세페이지 이미지 합성해줘" → `moai-seller:commerce-detail-page-image` (1080×12720 PNG)
- "랜딩 페이지 만들어줘" → `moai-marketer:marketing-landing-page` (단독 전환 1페이지)
...
- after: moai-seller:commerce-detail-page-copy → commerce-product-detail → moai-seller:commerce-detail-page-image 순차 체이닝
- alternative: 빠른 단일 카피만 → moai-seller:commerce-detail-page-copy 직접
