...
description: |
  ...
  ai-slop-reviewer 자동 체이닝 (진단 보고서 텍스트 산출물). 슬롭 검수 직후 moai-writer:korean-humanize으로 한국어 AI 티를 제거합니다 (슬롭 검수 다음, 필수).
...
| D 재고 & 물류 | 실시간 재고 동기화 |
| E 마케팅 & 고객 | 광고 리포트 자동 집계 (`moai-seller:commerce-marketplace-coupang-ads` 연계) |
