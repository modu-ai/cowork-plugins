...
description: |
  [책임 경계] 상품별 마진·엔드 ROAS(본전 ROAS)·손익분기 광고비 자동 계산 전담. 부가세·플랫폼 수수료·쿠폰·할인 모두 반영한 정확한 마진 산출. 페어 스킬 moai-seller:commerce-marketplace-coupang-ads(쿠팡 광고 운영 의사결정)와 명확히 구분 — 본 스킬은 마진·ROAS 계산 전담, 페어는 캠페인 분류·의사결정.
...
[Step 5] 권장 ROAS·쿠폰 전략·쿠팡 부가세 보정 경고 출력
   ↓ (선택) commerce-marketplace-coupang-ads 로 체이닝
```
...
commerce-margin-calculator (본 스킬, 마진·엔드 ROAS 산출)
       ↓ 광고 운영 단계에서
commerce-marketplace-coupang-ads (목표 ROAS·캠페인 분류·자동규칙)
       ↓ 매출 전략 통합 시
...
| 페어 스킬 | 차이 |
|----------|------|
| `moai-seller:commerce-marketplace-coupang-ads` | 쿠팡 광고 캠페인 분류·의사결정 (본 스킬: 마진·ROAS 계산만) |
...
| 광고 운영 연계 | 별도 | `moai-seller:commerce-marketplace-coupang-ads`와 자동 체인 |
