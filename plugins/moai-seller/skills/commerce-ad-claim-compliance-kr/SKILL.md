...
description: |
  ...
  입력 카피 → 유형별 검사 → 위반 항목별 근거 조문 + 수정안 제시. 규칙 기반 검증 스킬이라 general-ai-slop-reviewer 체이닝은 제외합니다.
...
- **법령 개정**: 조문 번호·기준은 개정될 수 있으므로 산출물에 점검 기준일을 명기하고, 최신 조문은 국가법령정보센터(`moai-lawyer` korean-law MCP)로 확인합니다.
