...
```
business-resume-builder → moai-coworker:general-ai-slop-reviewer → moai-writer:general-humanize-korean
```
...
```
moai-career:business-resume-builder → moai-coworker:general-ai-slop-reviewer → moai-writer:general-humanize-korean
```
...
JD 분석은 `moai-recruiter:business-job-analyzer`, 면접 준비는 `moai-career:business-interview-coach`, 포트폴리오는 `moai-career:business-portfolio-guide`와 함께 사용하세요.

## 이 스킬을 사용하지 말아야 할 때

- **채용공고(JD) 분석**: 공고를 분석하여 역량을 추출하려면 `moai-recruiter:business-job-analyzer` 스킬을 사용하세요.
- **면접 준비**: 면접 예상 질문이나 모의 면접은 `moai-career:business-interview-coach` 스킬이 적합합니다.
- **포트폴리오 구성**: 프로젝트 정리나 포트폴리오 전략은 `moai-career:business-portfolio-guide` 스킬을 사용하세요.
- **채용 담당자용 JD 작성**: 기업 인사 담당자가 JD를 작성하려면 `moai-recruiter:business-employment-manager` 스킬을 사용하세요.
