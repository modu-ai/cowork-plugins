...
**가장 쉬운 방법** — 설정(Settings) 또는 플러그인(Plugins) 메뉴 → 마켓플레이스(Marketplace)에서 주소 `modu-ai/moai-cowork`를 추가한 뒤, 플러그인 목록에서 `moai-career`를 찾아 **Install**을 누르세요.
...
codex plugin add moai-career@moai-cowork
```
