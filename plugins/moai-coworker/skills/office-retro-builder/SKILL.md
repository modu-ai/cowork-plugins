...
- → 도출한 행동은 `office-goal-planner`·`office-habit-routine`로 넘겨 실천으로 연결한다.

### 5단계: 회고 루틴화

- **주간**: 금요일 퇴근 전 또는 일요일 저녁 5분 고정
- **연간**: 12월에 키워드 회고 + 내년 목표 → `office-goal-planner` 연계
- **기록 장소**: 노션·메모 앱 등 한 곳에 모아 쌓기 → `office-notion-template-kit` 연계
...
- **팀 프로젝트 진척 관리·스프린트 보드**: `moai-coworker`를 사용한다.
- **직장 보고·회의 대화 스크립트**: 대인 커뮤니케이션은 `moai-coworker`로 보낸다.
