...
```text
business-executive-summary → office-html-report (mode=status, 기본)
...
→ business-executive-summary → office-html-report (기본)
...
→ weekly-report 6섹션 → business-executive-summary 1pager 6섹션
...
- 재무 → 경영진 카톡 공유: `finance-variance-analysis → business-executive-summary → general-ai-slop-reviewer → office-html-report (mode=status)`
- 재무 → 이사회 슬라이드: `finance-variance-analysis → business-executive-summary → office-html-report → office-pptx-designer`
- 재무 → 결재용 PDF: `finance-variance-analysis → business-executive-summary → office-html-report → office-pdf-writer`
- 주간 → C-level HTML: `weekly-report → business-executive-summary → office-html-report (mode=status)`
- 주간 → 공공기관 hwpx: `weekly-report → business-executive-summary → office-html-report → office-hwpx-writer`
