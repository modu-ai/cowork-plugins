---
name: business-pm-weekly-report
description: |
...
- **moai-coworker:business-executive-summary**: 1pager를 더 압축된 C-level 보고로 변환
...
- **NDA 정보 주의**: 외부 공유용 보고서 작성 시 회사 비밀 정보 자동 검사 (`moai-lawyer:legal-nda-triage` 권고)
...
- `moai-coworker:business-executive-summary` — C-level 1pager로 더 압축
...
- 등록된 스킬 체인:
  ...
  - 주간보고 → 임원 1pager: `weekly-report → moai-coworker:general-ai-slop-reviewer → moai-writer:general-humanize-korean → moai-coworker:business-executive-summary`
