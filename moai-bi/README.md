...
| 스킬 | 설명 | 출시 |
|---|---|---|
| [executive-summary](./skills/executive-summary/SKILL.md) | C-level 1pager (≤500단어, What/So What/Now What) | ✅ v2.0.0 |
| dashboard-designer | BI 대시보드 설계서 (Tableau/Looker/Metabase 입력) | ⏸️ v2.1+ |
| kpi-tree | North Star → 하위 지표 트리 분해 | ⏸️ v2.1+ |
| cohort-analyzer | 코호트 리텐션 분석 보고 | ⏸️ v2.1+ |
| funnel-analyzer | 전환 깔때기 + 드롭오프 진단 | ⏸️ v2.1+ |
