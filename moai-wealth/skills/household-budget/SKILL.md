...
- **moai-wealth/wealth-roadmap**: 확보한 저축 가능액으로 자산 로드맵 설계
- **moai-wealth/insurance-fit**: 고정비 중 보험료 점검·다이어트
- **moai-wealth/personal-tax-saver**: 절세로 실질 가처분 소득 늘리기
- **moai-productivity/retro-builder**: 소비 회고를 정기 회고 루틴에 통합

## 이 스킬을 사용하지 말아야 할 때

- **부채 과다·연체**: 단순 예산이 아니라 채무조정이 필요할 수 있다. 신용회복위원회 등 상담.
- **사업자 경비·장부**: 사업 회계는 `moai-finance` 계열을 사용한다.
