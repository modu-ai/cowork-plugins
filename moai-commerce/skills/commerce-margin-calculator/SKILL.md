...
description: |
  [책임 경계] 상품별 마진·엔드 ROAS(본전 ROAS)·손익분기 광고비 자동 계산 전담. 부가세·플랫폼 수수료·쿠폰·할인 모두 반영한 정확한 마진 산출. 페어 스킬 moai-commerce:marketplace-coupang-ads(쿠팡 광고 운영 의사결정)와 명확히 구분 — 본 스킬은 마진·ROAS 계산 전담, 페어는 캠페인 분류·의사결정.
...
| 무료 기간 | 1달 (가입 시) | 항상 무료 |
| 광고 운영 연계 | 자체 도구 | `moai-commerce:marketplace-coupang-ads`와 자동 체인 |
