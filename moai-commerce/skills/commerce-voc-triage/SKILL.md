...
description: |
  [책임 경계] VOC(Voice of Customer) 우선순위 판별 전담 — 3축 분류(고객 핏·빈도·핵심 가치 관련성) + KTAS 응급실 분류 적용한 처리 우선순위 매트릭스. 페어 스킬 commerce-review-aggregator(리뷰 통합 분석)와 명확히 구분 — 본 스킬은 VOC 처리 우선순위, 페어는 리뷰 데이터 분석.
