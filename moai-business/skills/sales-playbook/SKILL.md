...
B2B는 B2C의 확장이 아니라 **완전히 다른 게임**입니다. 같은 제품이라도 고객사 100개면 100개의 다른 제품을 파는 것과 같습니다.
...
| 차원 | B2C | B2B (한국 대기업) |
|---|---|---|
| 호흡 | 즉시 결제 | 미팅 → 견적·제안서 → 데모 → 담당자 기안 → 임원 승인 → **구매부 최종 승인** (최소 1~6개월) |
| 의사결정 | 본인 | 담당자 ≠ 의사결정자 ≠ 구매·재무·법무 |
| 메시지 | 브랜드 일관성 | **고객사·부서별 완전 재구성** |
| 판단 근거 | 욕구·감정·이미지 | **숫자·논리·합리성**, 매출·비용 효과 계량화 |
| 호흡 사례 | 30초 광고 후 결제 | 한국 대기업 = 통상 3~6개월, 코로나로 무기한 연기 케이스 다수 |

**② 100개 고객사 = 100개 다른 제품 (메시지 재구성)**

같은 B2B 교육 서비스라도:
- A고객사 "복지 제도" 컨셉 → 제안서·예시·콘텐츠 모두 복지 톤
- B고객사 "생산성 증가" 컨셉 → 연구 결과·흡입력 있는 영상 중심

제공 서비스는 동일하지만 구매 결정 맥락이 다르면 **메시지 톤·예시·강조점이 완전히 달라야** 함.

**③ 고객사 사전 분석 5종 (한국 표준)**

| 항목 | 도구 | 함정 |
|---|---|---|
| 무엇을 하는 회사인가 | DART 공시, 한경컨센서스, 홈페이지 | 외부 알려진 사업 ≠ 핵심 사업 (하이브 = BTS ≠ 위버스 플랫폼) |
| 직원 수 | 크레딧잡 (국민연금 연동) | 정규직·계약직 비율도 함께 |
| 매출·비용 | DART, 네이버 기업 검색 | 최근 2년 신설 사업의 매출 급증 = 진짜 집중 영역 |
| 투자 단계 (스타트업) | The VC, 플래텀, 벤처스퀘어 | 시리즈 단계 + 누적 투자금액 |
| 기업가치·MAU | 혁신의 숲 | 객단가·소비자층까지 |
...
|---|---|---|
| "혼자 결정 못 함, 내부 설득 어떻게?" | 우리 제품 자랑 | **"담당자 업무에서 얻을 구체적 결과"** 그림 그려주기 |
| "잘못될까 걱정" | 미리 만든 FAQ로 일방 답변 | **걱정을 진지하게 듣기 → 전문가로서 우려 잠재우기** |
| "새로 배우는 게 부담" | 기능 설명 일방 | 효과적 질문으로 현재 방식 듣기 → **"30분 안에 적용"** 부담 완화 |
...
- 경쟁사도 할 수 있는 이야기 제거
- 반복 페이지 제거 (한 케이스 5장 삭제로 핵심 더 부각)
- **고객 사례 페이지가 가장 유심히 보임** → 5~6줄 문장 → 임팩트 디자인으로 강화

**⑦ 무료 체험·자료 = 광고비**

B2B 고객은 "공짜는 없다"는 것을 알아 미지근. 그럼에도 무료 제공 이유:
...
- [ ] 미팅 주도권 = 담당자? 상사? → 누가 실제 영향력
- [ ] 회사 내 의사결정 회의 주기 (월·분기)

> 💡 한국 B2B 영업에서 가장 자주 실패하는 패턴: **고객사 사전 분석 부족 + 부서·담당자 무관한 단일 메시지 + 의사결정 프로세스 미파악**. 이 셋만 챙겨도 계약 전환율이 크게 올라갑니다.
