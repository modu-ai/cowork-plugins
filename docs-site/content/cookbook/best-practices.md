...
{{< hint type="note" >}}
Cowork는 "Research Preview" 단계로, **Pro / Max / Team / Enterprise** 플랜에서 이용 가능합니다.
{{< /hint >}}
...
1. **마켓플레이스 추가** — Cowork → Customize → Plugins → "+" → URL 입력: `https://github.com/modu-ai/cowork-plugins`
...
| 커스텀 | `SKILL.md` 직접 수정 | "Customize" 버튼으로 편집 |
