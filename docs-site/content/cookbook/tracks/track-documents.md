...
---
> **사용 방식 (v2.8.0+)**: 사용자가 짧은 한 줄 요청만 하면 시스템이 AskUserQuestion으로 맥락 수집 → 아래 스킬 체이닝 자동 실행. 사용자가 직접 스킬을 하나씩 호출할 필요 없음. [4가지 사용 패턴 참조](../../../cowork/patterns/)
>
> **한 줄 요청 예시**: "AI 영어 회화 앱 사업계획서 만들어줘" → 시스템 인터뷰 → 자동 체인 → DOCX 도착
