...
title: "제품 개발 트랙"
weight: 70
description: "PRD · 로드맵 · UX 자동화 - spec-writer → roadmap-manager → ux-designer → pptx-designer → ai-slop-reviewer"
...
- 제품 요구사항 문서화(`spec-writer`) 전문 스킬 활용법
- 제품 로드맵 관리(`roadmap-manager`) 기술
- UX 리서치 및 디자인(`ux-researcher`, `ux-designer`) 프로세스
...
첫 번째 스킬로 `spec-writer`를 활용한 제품 요구사항 문서화 스킬을 만듭니다.
...
두 번째 스킬로 `roadmap-manager`를 활용해 제품 로드맵을 생성합니다.
...
세 번째 스킬로 `ux-researcher`를 활용해 사용자 경험 리서치를 수행합니다.
...
네 번째 스킬로 `ux-designer`를 활용해 사용자 경험 디자인을 생성합니다.
...
- [spec-writer 제품 요구사항 작성 가이드](../../plugins/moai-core/spec-writer/)
- [roadmap-manager 로드맵 관리](../../plugins/moai-core/roadmap-manager/)
- [ux-researcher 사용자 리서치](../../plugins/moai-marketing/ux-researcher/)
- [ux-designer UX 디자인](../../plugins/moai-marketing/ux-designer/)
- [pptx-designer 발표 자료 생성](../../plugins/moai-office/pptx-designer/)
