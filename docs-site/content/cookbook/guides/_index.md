...
---
[트랙](../tracks/)을 마쳤다면 이제 도메인을 한층 깊이 파고들 차례입니다. 실무에서는 단순히 스킬을 아는 것을 넘어 "이 상황에서 왜 이 스킬이 필요한가"를 빠르게 판단할 수 있어야 합니다. 각 가이드는 특정 업무 상황을 먼저 그린 뒤, 문제를 해결하는 흐름을 한 호흡으로 설명합니다. 관심 있는 도메인 하나를 골라 시작하세요.
