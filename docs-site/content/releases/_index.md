...
- [v2.12.2 (최신)](v2.12.2/) - **moai-content:card-news 카드뉴스 프롬프트 완전 가이드 통합** — 10 구조 유형(비교·단계·체크리스트·Q&A·실수·입문·용어·문제해결·예시·템플릿)·통합 프롬프트·5 디자인 톤(Claude 톤 포함). Breaking change 없음
