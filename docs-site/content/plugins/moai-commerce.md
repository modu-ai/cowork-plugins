...
weight: 25
description: "한국 이커머스 셀러의 시장조사·고객 분석·상품명·상세페이지·채널 메시지·통합 전략·광고 최적화·자동화 진단·마진 계산·LTV/CAC 설계·앱 푸시·법규 준수·프로모션·재구매·이미지 파이프라인·리뷰 통합·VOC·구독·인플루언서·얼리팬·트렌드·시즌 캘린더 35 스킬로 한국 D2C 풀스택 자동화."
...
> 한국 이커머스 운영의 모든 단계를 한 플러그인 안에 담은 풀세트 35 스킬. 시장조사·고객 분석·상품명·NCM 메시지·통합 전략·광고 최적화·자동화 진단·마진 계산·LTV/CAC 설계·앱 푸시·법규 준수·프로모션 기획·재구매 골든타임·상품 이미지 파이프라인·리뷰 통합·VOC 우선순위·구독 모델·인플루언서 협업·얼리팬 부트스트랩·트렌드 변환·시즌 캘린더까지 자연어 한 줄 입력으로 자동 체인 호출.
