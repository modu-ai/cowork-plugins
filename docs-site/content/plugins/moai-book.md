...
책을 쓰겠다고 마음먹었지만 막상 어디서 시작해야 할지 모른다면, 또는 원고는 있는데 어느 출판사에 보내야 할지 막막하다면 `moai-book`이 그 전 과정을 처음부터 끝까지 이끌어 줍니다. 도서 컨셉서·타깃 독자 페르소나·목차 설계·저자 약력·출판 제안서·출판사 매칭·본문 챕터·퇴고 — 8 단계가 단일 플러그인 안에서 체이닝됩니다.

실용서·인문·기술서·소설 **4 장르 자동 분기**가 모든 스킬에 내장되어 있어, 장르를 한 번만 지정하면 이후 단계는 그 장르의 한국 출판사 컨벤션(어미·시점·문체·인용 패턴·표기 규칙)을 자동으로 따릅니다.

한국출판문화산업진흥원(KPIPA) 국민독서실태조사, 국립국어원 한글 맞춤법·외래어 표기법, 도서정가제(신간 18개월 정가 + 최대 10% + 5% 적립), 교보문고·알라딘·예스24 베스트셀러 통합 차트를 데이터 소스로 통합해 두었습니다.
...
한국 출판 시장에 특화된 데이터와 기준이 플러그인 전반에 내장되어 있습니다. KPIPA는 출판 시장 데이터·국민독서실태조사·표준 양식을 제공하고, 국립국어원 한글 맞춤법·외래어 표기법과 도서정가제(신간 18개월 정가 + 최대 10% 가격할인 + 5% 적립)도 반영합니다. 베스트셀러 분석은 교보문고·알라딘·예스24 3사 통합을 권장합니다.

출판사 데이터베이스는 IT(한빛·인사이트·제이펍·길벗 IT), 실용(웅진·다산북스·길벗·메가스터디북스), 인문(민음사·문학동네·창비·휴머니스트·은행나무·돌베개), 문학(문학과지성사·자음과모음), 아동(비룡소·사계절·창비 어린이) 등 30개 이상을 포함합니다. 신인 등단 경로(문학동네신인상·창비신인상·민음 신인 발굴)와 자비 출판 5가지 대안(부크크(POD)·텀블벅 출판 펀딩·인디고·카카오 브런치북·출판사 자비)도 안내합니다.
...
이 플러그인은 **한국 출판 시장에 특화**되어 있습니다. 해외 출판은 권장 출판사·도서정가제·KPIPA 통계 등 한국 컨텍스트가 적용되지 않으니 참고하세요. 외부 참고 자료의 비유·표현을 직접 인용하지 않고 자체 재구성 후 한국 출판사 컨벤션으로 변환합니다.

퇴고 단계에서 `moai-content:humanize-korean` + `moai-core:ai-slop-reviewer`는 **필수**입니다. AI 티가 남아 있으면 출판사 거절 사유가 될 수 있습니다.
