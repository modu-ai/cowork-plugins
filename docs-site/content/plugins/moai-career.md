...
`moai-career`는 STAR 기법 기반 자기소개서 작성, ATS(지원자 추적 시스템) 친화 이력서·영문 CV·링크드인 프로필, JD 분석과 기업 리서치·역량 매칭, AI·BEI·PT·토론·임원 유형별 면접 대비와 모의 면접, 개발·디자인·마케팅 포트폴리오 구성(GitHub·Behance·Notion 최적화)까지 취업·이직 전 주기를 지원합니다.
