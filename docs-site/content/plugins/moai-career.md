...
한국 채용 환경에 맞게 8가지 기능이 특화되어 있습니다. `interview-coach`는 조직 전체 컬처핏이 아닌 **함께 일할 팀의 업무 스타일·갈등 대응** 질문을 별도 팀핏 모드로 처리합니다. 챗GPT·제미나이 흔적이 남는 표현(추상 형용사·결론 클리셰·"~한 경험이 있습니다")은 자동으로 감지해 재작성합니다.

블라인드 채용에 대응해 학력·나이·사진·출신 마스킹 옵션을 제공하고, 공기업 지원 시에는 NCS 직무기술서 양식으로 자동 변환합니다. 수시채용과 핀셋 채용에서는 동일 회사의 다른 직무·과거 6~12개월 채용 이력을 분석해 현재 우선순위를 추출합니다. 헤드헌터 오퍼가 들어오면 사람인 출신 오퍼 검증 + 영문/국문 이력서 병행 + 희망 연봉 ±20% 가이드를 제공합니다. 자소서 분량은 500/1000/1500자별 KKK-STAR 비율을 자동으로 조정하며, 탈락 후 받은 피드백은 다음 지원에 누적 반영합니다.
