...
채용을 시작하면 JD 작성부터 면접 질문 설계, 합격자 제안서와 근로계약서 발송, 첫 출근 이후 온보딩까지 챙겨야 할 서류가 끊이지 않습니다. 분기마다 OKR 목표를 설정하고 평가 시즌마다 360도 리뷰 폼을 새로 만들어야 하며, 원격·하이브리드로 전환할 때는 근무 정책 문서까지 정비해야 합니다. 이 모든 과정에서 법령 기준이 틀리면 나중에 더 큰 문제가 됩니다.

`moai-hr`은 이 HR 전 영역을 커버합니다. 2026년 기준 4대보험 요율과 근로기준법 조항을 계약서 템플릿에 자동 반영하고, 스톡옵션 부여계약서 표준 조항도 포함되어 있어 법무 검토 전 초안을 빠르게 완성할 수 있습니다.
...
2026년 기준 4대보험 요율이 자동 반영되고 근로기준법 조항을 기반으로 계약서 템플릿이 구성됩니다. 스톡옵션 부여계약서 표준 조항도 포함되어 있어 법무팀에 넘기기 전 초안 수준을 갖춰둘 수 있습니다.
