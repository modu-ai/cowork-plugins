...
description: |
  [책임 경계] 랜딩페이지 6섹션 구조 진단 + CTR/CVR 분기별 개선 처방 + 메시지 일치 점검 전담. 페어 스킬 moai-content:landing-page(shadcn/ui 랜딩 코드 생성)와 명확히 구분 — 본 스킬은 기존 랜딩 페이지 진단·개선 처방, 페어는 신규 랜딩 페이지 코드 생성.
  ...
  v2.4.0 신규 (정승우님 자료 4 — 온라인 광고의 심리학 §9 랜딩페이지 풀세트, NOTICE.md 참조).
user-invocable: true
version: 2.5.0
---
...
기존 랜딩페이지 URL 또는 스크린샷을 입력받아 6섹션 구조·전환율 진단·개선 처방을 자동 생성하는 스킬. 자료 4 §9 풀세트를 wrapping.
