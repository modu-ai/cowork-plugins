...
**잘 안 될 때**
- 결과가 너무 일반적이면: 상황·대상·분량을 한 문장씩 더 붙여보세요. 요청이 구체적일수록 결과도 구체적입니다. [프롬프트 작성법](../../chat/prompts/)에 요령이 정리되어 있습니다.
...
- [프롬프트 작성법](../../chat/prompts/) — 같은 직원에게 더 좋은 결과를 받아내는 5원칙
- [컨텍스트 엔지니어링 기초](../../chat/context-engineering/) — 파일·Projects·메모리를 언제 어떻게 쓸지
