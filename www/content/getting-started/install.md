...
ChatGPT도 무료로 시작할 수 있고, Work 모드의 고급 기능은 유료 요금제에서 제공됩니다.

| 요금제 | 대략의 성격 | 이런 분에게 |
|---|---|---|
| **Free (무료)** | 기본 대화 가능, 웹 검색 제한적 | 일단 체험해 보고 싶은 분 |
| **Plus (유료)** | 웹 검색 무제한, 파일 업로드, Work 모드 전체 | 매일 업무에 쓰는 분 |
| **Team / Enterprise** | 팀 단위 계정·관리 기능, 관리 콘솔 | 회사에서 여럿이 함께 쓰는 경우 |

{{< hint "tip" >}}
**처음엔 무료로 충분합니다.** 이 가이드의 실습은 전부 무료 요금제로도 따라올 수 있습니다. "메시지 한도에 도달했습니다"라는 안내를 자주 만나게 되는 시점이 유료 전환을 고민할 때입니다. 정확한 가격과 제공량은 각 서비스의 요금 안내 페이지에서 확인하세요.
