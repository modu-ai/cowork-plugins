...
모두의 코워크를 쓰려면 Claude **Pro 이상(유료)**이 필요합니다. Pro부터 Projects·고성능 모델 등 코워크에 필요한 기능이 열립니다.
...
마찬가지로 모두의 코워크를 쓰려면 ChatGPT **Plus 이상(유료)**이 필요합니다. Work 모드 전체가 Plus 요금제부터 제공됩니다.
