...
숫자와 인용이 들어가는 문서가 많은 만큼, 데이터 출처를 따로 검증하는 검수 코워커가 붙어 있습니다.
...
**doc-producer**(실행 코워커)가 보고서·슬라이드·양식 문서를 생산하고, **data-auditor**(검수 코워커)가 읽기 전용으로 공공데이터 인용과 계산을 독립 검증합니다. 통계 수치가 들어간 보고서일수록 이 이중 확인이 빛을 발합니다.
