...
모두의 코워크 마켓플레이스에는 직무별 **AI 코워커**가 모여 있습니다. 크게 세 축으로 나뉩니다: 프로젝트를 여는 **범용** 축(PM·코워커), 특정 직무를 파고드는 **전문가** 축(셀러·사무관·데이터 애널리스트·법무·재무·인사·CS·컨설턴트·커리어·튜터), 그리고 만드는 일을 돕는 **크리에이티브** 축(작가·스토리·마케터·미디어·유튜버·디자이너)입니다.
...
| [유튜버](youtuber/) | 미디어 운영 | 라이브 방송·촬영/편집 지시·썸네일·발행·성과 리뷰·댓글·쇼츠 | 8 |
