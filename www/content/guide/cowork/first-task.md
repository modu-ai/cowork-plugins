...
![Cowork 첫 작업 — 프롬프트 입력](/screenshots/cowork/cowork-firsttask-prompt.png)

작업 폴더를 선택하고 원하는 작업을 자연스럽게 입력합니다.
...
![Cowork 결과 확인 — 생성된 보고서 검증](/screenshots/cowork/cowork-firsttask-result.png)

생성된 Word 보고서 파일을 바로 열어서 결과를 확인할 수 있습니다.
