...
문서 자동화 트랙을 처음 보면 "문서 하나 만들면 되지 왜 Word·PPT·Excel·한글·PDF 다섯 갈래로 갈라져 있나?"라는 의문이 듭니다. 이유는 목적이 다르기 때문입니다. 인쇄소에 비유하면 이해가 쉽습니다. 손님이 원고를 들고 오면 코워커가 먼저 "이걸 뭘로 만들 거냐" 묻습니다. 보고서면 워드 인쇄기로, 발표 자료면 슬라이드 인쇄기로, 표면 엑셀 인쇄기로 찍습니다. 기계가 다르듯 만드는 스킬도 다릅니다. 같은 원고라도 "읽는 글"인지, "보여주는 발표"인지, "계산하는 표"인지에 따라 어울리는 결과물이 갈립니다.
