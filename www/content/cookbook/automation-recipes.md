...
---
> Schedule은 **시간의 자동화**, Dispatch는 **공간의 확장**입니다. 둘을 결합하면 "내가 자리에 없어도 내 AI 코워커는 계속 일하는" 상태가 만들어집니다.
