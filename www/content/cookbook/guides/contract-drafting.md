...
[프로젝트 메모리](../../../cowork/projects-memory/)의 `general-feedback` 종류로 저장되어, 같은 프로젝트의 다음 NDA 검토에서 자동 적용됩니다.
...
- moai-lawyer 플러그인 [`legal-contract-review`](https://github.com/modu-ai/moai-cowork/blob/main/plugins/moai-lawyer/skills/legal-contract-review/SKILL.md), [`legal-nda-triage`](https://github.com/modu-ai/moai-cowork/blob/main/plugins/moai-lawyer/skills/legal-nda-triage/SKILL.md)
