...
title: "v2.4.x 릴리스 노트"
weight: 900
description: "캠프 후속 인사이트 통합본 — 정승우님 본인 노하우 3개 문서 + 광고 심리학 완전판을 분석해 13건(신규 5 + 강화 8) 통합. 124 → 129 스킬"
...
v2.4.0은 **"캠프 후속 인사이트 통합본"** 입니다. v2.3.0 출시 직후 GOOS행님이 분석에 넘겨준 정승우님 본인 노하우 3개 문서 + 광고 심리학 완전판(총 200+ 페이지)을 분석해 **13건(신규 5 + 강화 8)**으로 통합했습니다.

특히 `coupang-ad-optimizer`는 정승우님이 본인 매장에서 **월매출 7천 → 6개월 만에 3.6억, 광고비 매출 30% → 11.2%** 까지 끌어낸 6개월 노하우를 wrapper 스킬화 한 것으로, 캠프 D-14 운영 직전에 강의 전 단계에서 즉시 활용 가능합니다.
...
- **원전**: 정승우님 "쿠팡 매출 9배 올려준 광고관리 비법" 전자책 126p
- **핵심**: 검색영역 vs 비검색영역 CPM 167배 차이 분리 분석, 캠페인 = 정리함 원칙(상품 1개당 캠페인 1개), 목표 ROAS = 입찰가 조절 역할, 오디언스 플러스 OFF·할인쿠폰 ON·키워드 제외 500개
- **링크**: [SKILL.md](https://github.com/modu-ai/cowork-plugins/blob/v2.4.0/moai-seller/skills/coupang-ad-optimizer/SKILL.md)

#### commerce-margin-calculator
- **한 줄**: 상품별 마진·엔드 ROAS(본전 ROAS)·손익분기 광고비 자동 계산
- **원전**: 정승우님 시크릿팡(secretpang.kr) 마진계산기 로직 + 자료 3 §4 엔드 ROAS 공식
- **핵심**: 채널별 수수료 자동 반영(스마트스토어 5.94% / 쿠팡 10-12% / 카페24 2-3% / 아임웹 0-2.5%), 부가세·결제 수수료·쿠폰 자동, AI 챗봇 자연어 입력
- **링크**: [SKILL.md](https://github.com/modu-ai/cowork-plugins/blob/v2.4.0/moai-seller/skills/commerce-margin-calculator/SKILL.md)

#### commerce-automation-audit
- **한 줄**: 셀러 운영 자체 진단 + 자동화 우선순위 점수 산정 + 3 Phase 로드맵
- **원전**: 정승우님 "커머스 업무 자동화 기획" 24p 풀세트
...
- **링크**: [SKILL.md](https://github.com/modu-ai/cowork-plugins/blob/v2.4.0/moai-seller/skills/commerce-automation-audit/SKILL.md)
...
- **링크**: [SKILL.md](https://github.com/modu-ai/cowork-plugins/blob/v2.4.0/moai-marketer/skills/landing-page-conversion-audit/SKILL.md)
...
- **링크**: [SKILL.md](https://github.com/modu-ai/cowork-plugins/blob/v2.4.0/moai-marketer/skills/pixel-audit/SKILL.md)
...
| 마켓플레이스 스킬 | 124 | **129 (+5)** |
| moai-seller | 19 | **22 (+3)** |
| moai-marketer | 8 | **10 (+2)** |
| 동기화 지점 | 146 | **151** |
| 쿠팡 광고 운영 | — | {{< icon circle-check >}} coupang-ad-optimizer |
| 마진·엔드 ROAS 자동 | — | {{< icon circle-check >}} commerce-margin-calculator |
| 자동화 진단·로드맵 | — | {{< icon circle-check >}} commerce-automation-audit |
| 랜딩 진단 | — | {{< icon circle-check >}} landing-page-conversion-audit |
| 픽셀·Lookalike | — | {{< icon circle-check >}} pixel-audit |
| 광고 심리학 적용 | 부분 | {{< icon circle-check >}} 완전판 (campaign-planner) |
...
### 영향받은 플러그인 페이지
- [moai-seller 플러그인 페이지](/moai-agents/seller/) — 19 → 22 스킬
- [moai-marketer 플러그인 페이지](/moai-agents/marketer/) — 8 → 10 스킬
...
- Python (uvx) 기반
- `cowork-plugins/mcp-servers/moai-seller/` monorepo
