...
title: "v2.1.x 릴리스 노트"
weight: 900
description: "한국어 AI 티 정밀 윤문 도입 — humanize-korean 신규 스킬. epoko77-ai/im-not-ai (MIT, 937 stars) Fast 모드 포팅. 10대 카테고리 × 40+ AI 티 패턴 SSOT, 의미 100% 보존 가드, A/B/C/D 등급 자동 판정"
...
v2.1.0은 **한국어 AI 티 정밀 윤문** 도입 릴리스입니다. [`epoko77-ai/im-not-ai`](https://github.com/epoko77-ai/im-not-ai) v1.6.1 (MIT, {{< icon star >}}937 stars)의 Fast 모드 단일 스킬 변형을 cowork에 포팅해, 영어권 humanizer가 약한 **한국어 고유 패턴**을 수술적으로 제거합니다.

기존 `moai-coworker:general-ai-slop-reviewer`가 일반 AI 슬롭을 1차 정리하고, 신규 `moai-writer:general-humanize-korean`이 **10대 카테고리 × 40+ AI 티 패턴 SSOT**를 기반으로 한국어를 2차 정밀 윤문하는 **2단 체인 구조**가 표준 권장 워크플로우가 되었습니다.
...
### moai-marketer: humanize-korean (한국어 AI 티 정밀 윤문)

**전체 경로**: `moai-writer:general-humanize-korean`
...
**관련 링크**:
- [SKILL.md](https://github.com/modu-ai/cowork-plugins/blob/v2.1.0/moai-marketer/skills/humanize-korean/SKILL.md)
- [분류 체계 SSOT (40KB)](https://github.com/modu-ai/cowork-plugins/blob/v2.1.0/moai-marketer/skills/humanize-korean/references/ai-tell-taxonomy.md)
- [윤문 처방 playbook](https://github.com/modu-ai/cowork-plugins/blob/v2.1.0/moai-marketer/skills/humanize-korean/references/rewriting-playbook.md)
- [정량 메트릭 metrics.py](https://github.com/modu-ai/cowork-plugins/blob/v2.1.0/moai-marketer/skills/humanize-korean/references/metrics.py)
- [원본 저장소: epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai) (MIT License, {{< icon star >}}937)
...
### moai-marketer plugin description 갱신

`moai-marketer/.claude-plugin/plugin.json`의 `description`·`keywords`에 `humanize-korean`·`한국어윤문`·`AI티제거`·`humanize` 키워드가 추가되었습니다.

### CLAUDE.md.tmpl 한국어 권장 체인 명시

`/project init`이 생성하는 CLAUDE.md 템플릿(`moai-coworker/skills/project/references/templates/CLAUDE.md.tmpl`)에 다음 한국어 권장 체인이 명시되었습니다:
...
Claude Cowork에서 `moai-marketer` 플러그인 상세 페이지를 한 번 닫았다가 다시 열면 신규 `humanize-korean` 스킬이 표시됩니다.
...
본 릴리스의 신규 스킬은 [`epoko77-ai/im-not-ai`](https://github.com/epoko77-ai/im-not-ai) v1.6.1 (MIT License, {{< icon star >}}937 stars) Fast 모드 단일 스킬 변형을 포팅했습니다.
...
- 원본 스킬 저장소: [epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai) (MIT, {{< icon star >}}937)
