...
- **홈 카드 라벨 정정** — v2.11.0이 두 번 표시되던 것을 v2.10.0(moai-writer 8 스킬)로 정정
...
이전: v2.11.0 카드가 두 번 표시 (두 번째가 moai-writer 내용인데 라벨이 v2.11.0)
...
- [v2.10.0 릴리스 노트](/releases/v2.10/) (moai-writer 신규)
- [moai-media 플러그인 페이지](/moai-agents/media/) (4 스킬)
