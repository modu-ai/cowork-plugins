...
- **moai-productivity:goal-planner**: 회고에서 나온 다음 행동을 목표·계획으로 전환
- **moai-productivity:habit-routine**: 회고 루틴 자체를 습관으로 정착
- **moai-productivity:weekly-report**: 업무 주간보고와 한 주 회고를 함께 운영
- **moai-wealth:household-budget**: 소비 회고를 개인 회고 루틴에 통합

## 이 스킬을 사용하지 말아야 할 때

- **팀 프로젝트 진척 관리·스프린트 보드**: `moai-product`를 사용한다.
- **직장 보고·회의 대화 스크립트**: 대인 커뮤니케이션은 `moai-comms`로 보낸다.
