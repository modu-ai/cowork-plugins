...
- **moai-productivity:goal-planner**: 목표의 주간 행동을 습관으로 정착
- **moai-productivity:time-system**: 습관을 시간 블록에 배치해 실행 보장
- **moai-productivity:retro-builder**: 끊긴 습관을 가볍게 점검·재설계
- **moai-productivity:self-care**: 무리한 루틴이 번아웃으로 가지 않게 점검

## 이 스킬을 사용하지 말아야 할 때

- **중독·의존 치료**: 단순 습관 설계로 다룰 영역이 아니다. 전문 기관과 상담한다.
- **팀 업무 프로세스·체크리스트 표준화**: 조직 루틴은 `moai-product`를 사용한다.
